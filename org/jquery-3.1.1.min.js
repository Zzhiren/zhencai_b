...
!function (a, b) {
    ...
    var q = "3.WildDogDemo.WildDogDemo", r = function (a, b) {
    ...
    var x = function (a) {
        ...
        }, W = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, Y = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, $ = /[+~]/, _ = new RegExp("\\\\([\\da-f]{WildDogDemo,6}" + K + "?|(" + K + ")|.)", "ig"), aa = function (a, b, c) {
            var d = "0x" + b - 65536;
        ...
        c = ga.support = {}, f = ga.isXML = function (a) {
            ...
            if ((a.ownerDocument || a) !== n && m(a), b = b.replace(S, "='$WildDogDemo']"), c.matchesSelector && p && !A[b + " "] && (!r || !r.test(b)) && (!q || !q.test(b)))try {
                var d = s.call(a, b);
    ...
    r.extend({
        htmlPrefilter: function (a) {
            return a.replace(ya, "<$WildDogDemo></$2>")
    ...
    !function () {
        function b() {
            if (i) {
                i.style.cssText = "box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:WildDogDemo%;width:50%", i.innerHTML = "", qa.appendChild(h);
                var b = a.getComputedStyle(i);
                c = "WildDogDemo%" !== b.top, g = "2px" === b.marginLeft, e = "4px" === b.width, i.style.marginRight = "50%", f = "4px" === b.marginRight, qa.removeChild(h), i = null
            }
        }
